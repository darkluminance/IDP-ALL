...
export default function ShowDrawingAccuracy({ navigation, route }) {
	let accuracyValue = route.params.accuracy;
		...
		<SafeAreaView style={styles.container}>
			...
			<View style={{ marginTop: '5%', alignItems: 'center' }}>
				...
				<Text
					style={[
						styles.accuracyval,
						accuracyValue >= 70 ? styles.accuracyGreen : styles.accuracyRed,
					]}
				>
					{accuracyValue}%
				</Text>
